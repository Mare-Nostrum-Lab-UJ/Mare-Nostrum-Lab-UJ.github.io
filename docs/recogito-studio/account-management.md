...
1. Provide your **Username** and **Password**, then click the **"Sign In"** button.
    ...
    ![Sign in](account-management/login-to-recogito.png)
...
1. Click the **"Forgot password?"** option.
    ...
    ![Forgot password?](account-management/forgot-password.png)

1. Provide your email address and submit the reset request.

    ![Email address for reset](account-management/provide-email-for-reset.png)
...
1. Click **"Profile Settings"** option.
    ...
    ![Profile settings](account-management/profile-settings.png)
